							...
							<tr>
                                ...
                                <!------- IF untuk avatar foto -------->
                                   <?php
                                    ...
                                    if ($dp['foto'] == '') {
                                         echo "<img width='40' height='40'  src='" . base_url() . "assets/file_user/user-b.png'>";
                                    } else {
								...
								<td align="center">
                                    <a href="<?php echo base_url(); ?>admin/pengguna/edit/<?php echo $dp['id_user']; ?>"><button class="btn-sm btn-success"><i class="ace-icon fa fa-pencil-square-o "></i></button>
                                    </a>
                                    <a href="<?php echo base_url(); ?>admin/pengguna/hapus/<?php echo $dp['id_user']; ?>" onClick="return confirm('Anda yakin..???');" title="Hapus"><button class="btn-sm btn-danger"><i class="ace-icon fa fa-trash"></i></button>
                                    </a>
                                </td>
							</tr>
