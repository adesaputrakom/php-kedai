			...
			<div class="col-xs-12">
				<div class="box-content card white">
					...
					<div class="card-content">
						...
						<?php echo form_open_multipart('user/setting/simpan_ubah', 'class="form-horizontal"'); ?>
							...
							<div class="form-group">
								...
								<input type="text" disabled="" class="form-control" name="level" value="<?php echo $level; ?>">
							</div>
							<div class="form-group">
